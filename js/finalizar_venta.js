                ...
                if (d.detalles && d.detalles.length > 0) {
                    ...
                    if (isSucursalUnica) {
                        ...
                        if (tieneEnvioGuardado) {
                            ...
                            // Seleccionamos el dropdown si coincide el texto
                            if ($('#selector_contacto_gral').length > 0) {
                            ...
                            // ✨ NUEVO: Si es una cotización nueva (sin direcciones) pero eligió Plaza en la cotización, ¡la auto-seleccionamos!
                            let indexPlaza = doms_plaza.findIndex(dt => dt.Plaza_id == equipo_base.plaza_guardada);
                            if (indexPlaza !== -1) {
                                $('#selector_contacto_gral').val(indexPlaza).trigger('change');
                            }

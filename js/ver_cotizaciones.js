$(document).ready(function() {
                ...
                data.forEach(function(cot) {
                    ...
                    let tr = `
                        <tr>
                            ...
                            <td><span class="badge bg-soft-success text-success">Guardada</span></td>
    ...
    $(document).on('click', '.btn-editar-modal', function(e) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                // ¡LÓGICA DEL CLIENTE B2B! - Ocultamos y bloqueamos campos para proteger la cotización
                ...
                cargarSolicitantes(cot.Empresa_id, cot.Usuario_empresa_id);
    ...
    function cargarSolicitantes(id_empresa, preseleccion = null) {
        $.ajax({

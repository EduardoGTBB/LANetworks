...
<body>
                    ...
                    <div class="col-lg-12 mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-end">
                                <a style="font-size:14px;" class="btn-lg btn-primary" id="btnNuevoAdmin" href="#"><i class="feather-plus-circle"></i>&nbsp; Agregar usuario</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
            ...
            <div class="customizer-sidebar-body position-relative p-4" data-scrollbar-target="#psScrollbarInit">
                ...
                <div class="position-relative px-3 pb-3 pt-4 mt-3 mb-0 border border-gray-2 theme-options-set">
                    ...
                    <div class="row g-2 theme-options-items font-family" id="fontFamilyList">
                        ...
                        <div class="col-6 text-center single-option">
                            <input type="radio" class="btn-check" id="app-font-family-maven- " name="font-family" value="16" data-font-family="app-font-family-maven-pro">
    ...
    <!--! END: Theme Customizer !-->
    <script src="js/ver_usuarios.js"></script>
</body>

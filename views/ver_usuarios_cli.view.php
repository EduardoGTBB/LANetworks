            ...
            <div class="page-header">
                <div class="page-header-left d-flex align-items-center">
                    <div class="page-header-title">
                        <h5 class="m-b-10">Usuarios de Clientes</h5>
                    </div>
                    <ul class="breadcrumb">
                    ...
                    <div class="col-lg-12 mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-end">
                                <a style="font-size:14px;" class="btn-lg btn-primary" id="btnNuevoUsuario" href="# "><i class="feather-plus-circle"></i>&nbsp; Agregar usuario</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form id="formUsuario" class="modal-content bg-white" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-lg-8">
                            <div class="mb-4 mb-md-0 d-flex gap-4 your-brand">
                                <div class="wd-100 ht-100 position-relative overflow-hidden border border-gray-2 rounded">
                                    <img src="assets/images/avatar/user.png" id="preview_foto_cli" class="h-100 w-100" style="object-fit: cover;" alt="Perfil">

                                    <div class="position-absolute start-0 top-0 h-100 w-100 d-flex align-items-center justify-content-center c-pointer upload-button" onclick="document.getElementById('input_foto_cli').click()">
                                        <i class="feather feather-camera" aria-hidden="true"></i>
                                    </div>

                                    <input class="file-upload d-none" type="file" name="foto_perfil" id="input_foto_cli" accept="image/*">
                                </div>
                    ...
                    <input type="hidden" name="action" id="usuario_action" value="crear">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="apellido_pat" id="apellido_pat" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Apellido Materno <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="apellido_mat" id="apellido_mat" required>
                        </div>
                    </div>
                    ...
                    <div id="bloque_estatus_usr" class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="estatus_usr" name="activo" value="true" checked>
                                <label class="form-check-label" for="estatus_usr">Usuario Activo</label>
                            </div>
                        </div>
                    </div>
                </div>

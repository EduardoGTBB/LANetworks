                    ...
                    <div class="col-lg-12 mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-end">
                                <a style="font-size:14px;" class="btn-lg btn-primary" id="btnNuevoProducto" href="#"><i class="feather-plus-circle"></i>&nbsp; Agregar producto</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form id="formProducto" class="modal-content bg-white" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-lg-8">
                            <div class="mb-4 mb-md-0 d-flex gap-4 your-brand">
                                <div class="wd-100 ht-100 position-relative overflow-hidden border border-gray-2 rounded">
                                    <img src="assets/images/productos/producto.png" id="preview_foto_prod" class="upload-pic img-fluid rounded h-100 w-100" alt="Producto">

                                    <div class="position-absolute start-0 top-0 h-100 w-100 d-flex align-items-center justify-content-center c-pointer upload-button" onclick="document.getElementById('input_foto_prod').click()">
                    ...
                    <div id="bloque_estatus_prod" class="row mt-3">
                        <div class="col-md-12">
                            <hr>
                            <p class="fw-bold"><i class="feather-settings"></i> Configuración</p>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="estatus_prod" name="estatus" value="Y" checked>
                                <label class="form-check-label" for="estatus_prod">Producto Activo</label>
                            </div>
                        </div>
                    </div>
                </div>

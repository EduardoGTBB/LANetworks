 <!--! [Start] Header !-->
    ...
    <header class="nxl-header">
        <div class="header-wrapper position-relative w-100">
            <!--! [Start] Header Left !-->
            ...
            <div class="header-right ms-auto">
                <div class="d-flex align-items-center">
                    <div class="d-none d-lg-flex align-items-center border-end pe-4">
                        <img src="assets/images/logo/ChatGPT Image 10 sept 2026, 06_39_19 p.m.png" alt="Analytical for a better life" style="max-height: 35px; object-fit: contain;">
                    </div>
                    ...
                    <div class="dropdown nxl-h-item">
                        <!-- <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="assets/images/avatar/<php echo htmlspecialchars($_SESSION['foto_perfil'] ?? 'user.png'); ?>" alt="user-image" class="rounded-circle" style="width: 38px; height: 38px; object-fit: cover;" />
                        </a> -->
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside" class="d-flex align-items-center gap-2">
                            <!-- ✨ UX: Ajustamos el tamaño del avatar para mejor proporción -->
                            <img src="assets/images/avatar/<?php echo htmlspecialchars($_SESSION['foto_perfil'] ?? 'user.png'); ?>" alt="user-image" class="rounded-circle shadow-sm" style="width: 42px; height: 42px; object-fit: cover; border: 2px solid #fff;" />
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="assets/images/avatar/<?php echo htmlspecialchars($_SESSION['foto_perfil'] ?? 'user.png'); ?>" alt="user-image" class="rounded-circle me-3" style="width: 55px; height: 55px; object-fit: cover;" />
                                    <div>
                                        <h6 class="text-dark mb-0">
                                            <?php echo htmlspecialchars($_SESSION['nombre_completo'] ?? 'Usuario'); ?>
                                            <span class="badge bg-soft-success text-success ms-1"></span>
                                        </h6>
                                        <span class="fs-12 fw-medium text-muted">
                                            <?php 
                                                // Si existe correo, es cliente. Si existe usuario_lan, es admin.

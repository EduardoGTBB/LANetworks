...
<div class="page-header d-flex flex-wrap align-items-center shadow-sm" style="position: sticky; top: 80px; z-index: 99; min-height: 75px !important; padding-top: 18px !important; padding-bottom: 18px !important; margin-bottom: 25px;">
    ...
    <!-- ✨ Bloque Izquierdo: Título y Ruta (Ajuste Responsivo) -->
    <!-- Cambiamos a flex-column en móviles y flex-md-row en PC -->
    <div class="page-header-left d-flex flex-column flex-md-row align-items-start align-items-md-center">
        <div class="page-header-title">
            <h5 class="mb-2 mb-md-0 pe-md-3"><?php echo $page_title ?? 'Módulo'; ?></h5>
        </div>
    ...
    <!-- Bloque Central Dinámico (Fechador u otros controles) -->
    ...
    <!-- Agregamos mt-3 mt-sm-0 para separar el botón si baja a una nueva línea en móviles -->
    <div class="page-header-right ms-auto d-flex align-items-center mt-3 mt-md-0">

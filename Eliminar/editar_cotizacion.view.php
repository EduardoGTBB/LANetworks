...
<body>
                            ...
                            <div class="card-body lead-status">
                                <div class="mb-5 d-flex align-items-center justify-content-between">
                                    <h5 class="fw-bold mb-0 me-4">
                                        <span class="d-block mb-2">Editar cotización</span>
                                ...
                                <form enctype="multipart/form-data" id="editar_cotizacion" action="" method="POST">
                                    <input type="hidden" name="id_cotizacion" value="<?php echo $id_cotizacion; ?>">
                                    <input type="hidden" name="fecha_cot" value="<?php echo htmlspecialchars($cotizacion_actual['fecha_cot']); ?>">
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <label class="form-label">Cliente</label>
                                            <select class="form-control" id="select_empresa" name="Empresa_id" data-selected="<?php echo $cotizacion_actual['Empresa_id']; ?>" required>
                                                <option value="">Selecciona un cliente...</option>
                                                <!-- <option value="1">COMERCIALIZADORA FARMACEUTICA DE CHIAPAS</option> -->
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <label class="form-label">Solicitante</label>
                                            <select class="form-control" id="select_solicitante" name="Usuario_id" required>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-12">
                                            <div class="mb-4">
                                                <h5 class="fw-bold">Productos cotizados:</h5>
                                                ...
                                                <table class="table table-bordered overflow-hidden" id="tab_logic">
                                                    <thead>
                                                        <tr class="single-item">
                                                            <th class="text-center wd-150">#</th>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        // 1. Validamos si hay productos en la BD
                                                        if (isset($detalles_actuales) && count($detalles_actuales) > 0) {
                                                            foreach ($detalles_actuales as $index => $item) {
                                                        ?>
                                                                <tr id="addr<?php echo $index; ?>">
                                                                    <td class="text-center"><?php echo $index + 1; ?></td>
                                                                    <td>
                                                                        <select class="form-control product-select" name="productos[]" required data-selected="<?php echo $item['Product_id']; ?>">
                                                                            <option value="">Cargando producto...</option>
                                                                        </select>
                                                                    </td>
                                                                    <td><input type="number" name="unitario[]" value="<?php echo $item['precio_unitario']; ?>" class="form-control price" step="any" required></td>
                                                                    <td><input type="number" name="cantidad_cot[]" value="<?php echo $item['cantidad']; ?>" class="form-control qty" step="1" min="1" required></td>
                                                                    <td><input type="number" name="total[]" value="<?php echo $item['precio_extendido']; ?>" class="form-control total" readonly=""></td>
                                                                </tr>
                                                            <?php
                                                            }
                                                        } else {
                                                            ...
                                                            <tr id="addr0">
                                                                ...
                                                                <td><input type="number" name="unitario[]" class="form-control price" step="any" required></td>
                                                                <td><input type="number" name="cantidad_cot[]" class="form-control qty" step="1" min="1" required></td>
                                                ...
                                                <table class="table table-bordered" id="tab_logic_total">
                                                    <tbody>
                                                        <tr class="single-item">
                                                            ...
                                                            <td class="w-50">
                                                                <input type="number" name="sub_total" value="<?php echo $cotizacion_actual['importe_total']; ?>" class="form-control border-0 bg-transparent p-0" id="sub_total" readonly="">
                                                            </td>
                                                        </tr>
                                                        <tr class="single-item">
                                                            ...
                                                            <td class="w-50">
                                                                <div class="input-group mb-2 mb-sm-0">
                                                                    <input type="number" class="form-control border-0 bg-transparent p-0" id="tax" placeholder="16" value="16">
                                                        ...
                                                        <tr class="single-item">
                                                            ...
                                                            <td class="bg-gray-100 w-50">
                                                                <input type="number" name="total_amount" id="total_amount" value="<?php echo $cotizacion_actual['precio_iva'] ?>" class="form-control border-0 bg-transparent p-0 fw-700 text-dark" readonly="">
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
    ...
    <script src="js/update_cotizacion.js"></script>
    <script>
        const ID_CLIENTE_GUARDADO = <?php echo !empty($cotizacion_actual['Empresa_id']) ? $cotizacion_actual['Empresa_id'] : 'null'; ?>;
        const ID_SOLICITANTE_GUARDADO = <?php echo !empty($cotizacion_actual['Usuario_empresa_id']) ? $cotizacion_actual['Usuario_empresa_id'] : 'null'; ?>;
    </script>
</body>

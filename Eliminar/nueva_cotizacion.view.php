                            ...
                            <div class="card-body lead-status">
                                <div class="mb-5 d-flex align-items-center justify-content-between">
                                    <h5 class="fw-bold mb-0 me-4">
                                        ...
                                        <span class="fs-12 fw-normal text-muted text-truncate-1-line">Agrega los productos a cotizar.</span>
                                    </h5>
                                </div>
                                ...
                                <form enctype="multipart/form-data" id="nueva_cotizacion" action="<?php echo trim(stripcslashes(strip_tags(htmlspecialchars($_SERVER['PHP_SELF'])))); ?>" method="POST" name="nueva_cotizacion">
                                    ...
                                    <!--<div class="row">
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select class="form-control" data-select2-selector="status" name="Empresa_id" required>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <select class="form-control" data-select2-selector="status" name="Usuario_id" required>
                                                <option value="">Selecciona un solicitante...</option>
                                                <option value="1">Juan José García Peréz</option>
                                            </select>
                                        </div>
                                    </div>
                                                ...
                                                <table class="table table-bordered overflow-hidden" id="tab_logic">
                                                    ...
                                                    <tbody>
                                                        <tr id="addr0">
                                                            <td>1</td>
                                                            <td>
                                                                <select class="form-control" data-select2-selector="status" name="productos[]" required>
                                                            ...
                                                            <td><input type="number" name="unitario[]" placeholder="0.00" class="form-control price" step="1.00"></td>
                                                            <td><input type="number" name="cantidad_cot[]" placeholder="Cantidad" class="form-control qty" step="1" min="1"></td>
                                    ...
                                    <div class="row mt-3 mb-4">
                                        <div class="col-lg-12 d-flex justify-content-center">
                                            <input class="btn btn-primary" type="submit" value="Guardar" onclick="nueva_cotizacion.submit()">
                                        </div>
                                    </div>
                                </form>
                            </div>

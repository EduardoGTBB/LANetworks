                    ...
                    <div class="col-lg-12">
                        <div class="card stretch stretch-full">
                            ...
                            <div class="card-body custom-card-action">
                                <form enctype="multipart/form-data" id="editar_usuario" action="<?php echo trim(stripcslashes(strip_tags(htmlspecialchars($_SERVER['PHP_SELF'])))); ?>" method="POST" name="editar_usuario">
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="fullnameInput" name="admin_nombre" placeholder="Nombre(s)" value="Javier" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="feather-user"></i></div>
                                                <input type="text" class="form-control" id="fullnameInput" name="admin_apellidos" placeholder="Apellido(s)" value="Olguin" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="mailInput" name="usuario" placeholder="Escribe un usuario" value="contacto@lupware.com" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <select class="form-control" data-select2-selector="status" name="perfil" required>
                                                ...
                                                <option value="success" data-bg="bg-success" selected>Administrador</option>
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        <p><span class="fw-bold">Cambiar contraseña</span><br><span>Dejar vacío si no se desea cambiar la contraseña</span></p>
                                    </div>
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-8 generate-pass">
                                            <div class="input-group field">
                                                ...
                                                <input type="password" class="form-control password" id="newPassword" name="password" placeholder="Confirma la contraseña">
                                                        ...
                                                        <td class="text-end">
                                                            <div class="form-group select-wd-lg">
                                                                <select class="form-control" data-select2-selector="icon" name="mp_cotizador" required>
                                                                    ...
                                                                    <option value="Activado" data-icon="feather-toggle-right" selected>Activado</option>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        <div class="col-lg-12 d-flex justify-content-end">
                                            <input class="btn btn-primary" type="submit" value="Guardar" onclick="editar_usuario.submit()">
                                        </div>
                                    </div>
                                </form>
                            </div>

            ...
            $mail->Body = <<<HTML
                <div style='font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #eaeaea; padding: 20px; border-radius: 8px;'>
                    ...
                    <div style='text-align: center; margin: 30px 0;'>
                        <a href='https://cotizador.la-analitical-mx.net/login.php' style='background-color: #28a745; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;'>Acceder a mi Portal B2B</a>
                    </div>
